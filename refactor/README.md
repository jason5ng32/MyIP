...
| # | 文件 | 主题 | 状态 |
|---|---|---|---|
| 01 | [01-bootstrap-to-tailwind.md](./01-bootstrap-to-tailwind.md) | Bootstrap → Tailwind + shadcn-vue（彻底替换） | ✅ 主体完成（bootstrap 包已卸载、CSS 导入已删除、28 个组件逐个 rewrite；bootstrap-icons 列为 phase D 后续） |
