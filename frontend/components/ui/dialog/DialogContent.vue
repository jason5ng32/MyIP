...
<template>
  <DialogPortal>
    ...
    />
    <DialogContent
      :class="cn('fixed left-1/2 top-1/2 z-[10001] -translate-x-1/2 -translate-y-1/2 w-full max-w-lg gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg max-h-[90vh] overflow-y-auto', $props.class)"
